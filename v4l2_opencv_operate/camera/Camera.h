...
public:
	...
	int get_y_component(unsigned char *buffer, unsigned char *y_buffer,int * data_len);

	int set_REGISTER(int location,int value);
	int get_REGISTER(int location,__u64 *value);
